...
return '🌟| _أنـت لـسـت الـمـطـور _ ⚙️'
 ...
 return '🌟| المجموعه بالتأكيد ☑️️ تم تفعيلها'
...
return '🌟|تـم تـفـعـيـل الـمـجـمـوعـه ☑️️'
...
local function modrem(msg)
  ...
  if not data[tostring(msg.to.id)] then
    return '🌟| المجموعه بالتأكيد ☑️️ تم تعطيلها'
  end
...
if data[tostring(msg.to.id)]['filterlist'][(word)] then
 ...
 return  "🌟| _ الكلمه_ *"..word.."* _هي بالتأكيد من قائمه المنع☑️️_"
    
end
   data[tostring(msg.to.id)]['filterlist'][(word)] = true
     save_data(_config.moderation.data, data)

 return  "🌟| _ الكلمه_ *"..word.."* _تمت اضافتها الى قائمه المنع ☑️️_"
...
return  "🌟| _ الكلمه_ *"..word.."* _تم السماح بها ☑️️_"
     
      else

      return  "🌟| _ الكلمه_ *"..word.."* _هي بالتأكيد مسموح بها☑️️_"
...
local function modlist(msg)
  ...
  if not data[tostring(msg.chat_id_)] then
    ...
    return  "🌟| _هذه المجموعه ليست من حمايتي ☑️️_"
  
 end
  -- determine if table is empty
  if next(data[tostring(msg.to.id)]['mods']) == nil then --fix way

return  "🌟| _لا يوجد ادمن في هذه المجموعه ☑️️_"
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..']\n🌟| _ الايدي _*['..data.id_..']*\n🌟| _ انه بالتأكيد ليس من عضو مميز ☑️️ _', 0, "md")
       
  end
administration[tostring(arg.chat_id)]['whitelist'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟|_ تمت تنزيله من عضو مميز ☑️️_', 0, "md")
   end
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..']\n🌟| _ الايدي _*['..data.id_..']*\n🌟|_ انه بالتأكيد مدير ☑️️ _', 0, "md")
      end
   
administration[tostring(arg.chat_id)]['owners'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟|_ تمت ترقيته ليصبح مدير ☑️️_', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟|_ الايدي _*['..data.id_..']*\n🌟|_ انه بالتأكيد ادمن ☑️️_', 0, "md")
      end
   
administration[tostring(arg.chat_id)]['mods'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _ الايدي _*['..data.id_..']*\n🌟| _ تمت ترقيته ليصبح ادمن ☑️️_', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟| _انه بالتأكيد ليس مدير ☑️️_', 0, "md")
      end
   
administration[tostring(arg.chat_id)]['owners'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟| _تم تنزيله من الاداره ☑️️_', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _ الايدي _*['..data.id_..']*\n🌟| _انه بالتأكيد ليس ادمن ☑️️_', 0, "md")
      
  end
administration[tostring(arg.chat_id)]['mods'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _ الايدي_ *['..data.id_..']*\n🌟| _تم تنزيله من الادمنيه ☑️️_', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..']\n🌟| _ الايدي _*['..data.id_..']*\n🌟| انه بالتأكيد ليس من عضو مميز ☑️️ _', 0, "md")
      
  end
administration[tostring(arg.chat_id)]['whitelist'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌟| _العضو_ ['..user_name..'] \n🌟| _الايدي_ *['..data.id_..']*\n🌟| تمت تنزيله من عضو مميز ☑️️_', 0, "md")
...
local replay = data[tostring(target)]["settings"]["replay"]
 if replay == "☑️️" then
return '🌟| _مرحبا عزيزي_ \n🌟| _الردود بالتاكيد تم تشغيله ☑️️_'
else 
data[tostring(target)]["settings"]["replay"] = "☑️️"
save_data(_config.moderation.data, data) 
return '🌟| _مرحبا عزيزي_ \n🌟| _تم تشغيل الردود  ☑️️_'
end
end
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الروابط بالتأكيد تم قفلها_ ☑️️'
else
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الروابط بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الكلايش بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الكلايش بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _البوتات بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _البوتات بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الاضافه بالتاكيد تم قفلها  _ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الاضافه بالتاكيد تم فتحها  _ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الماركدوان بالتاكيد تم قفله _ ☑️️'

else
 data[tostring(target)]["settings"]["lock_markdown"] = "☑️️"
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل الماركدوان_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _المتحركه بالتأكيد تم قفلها_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_gif"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل المتحركه_ ☑️️'
...
local mute_gif = data[tostring(target)]["mutes"]["mute_gif"]
 if mute_gif == "❌" then
return '🌟| _مرحبا عزيزي_ \n🌟| _المتحركه بالتأكيد تم فتحها_ ☑️️'

else 
data[tostring(target)]["mutes"]["mute_gif"] = "❌"
 save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم فتح المتحركه_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الالعاب بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الألعاب بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الانلاين بالتأكيد تم قفله_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_inline"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل الانلاين_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الانلاين بالتأكيد تم فتحه_ ☑️️'

else 
data[tostring(target)]["mutes"]["mute_inline"] = "❌"
 save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم فتح الانلاين_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الدردشه بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الفيديو بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الفيديو يالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _البصمات بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _البصمات بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الصوت بالتأكيد تم فتحه_ ☑️️'

else 
data[tostring(target)]["mutes"]["mute_voice"] = "❌"
 save_data(_config.moderation.data, data)

return '🌟| _مرحبا عزيز��_ \n🌟| _تم فتح الصوت_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الملصقات بالتأكيد تم قفلها_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_sticker"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل الملصقات_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الملصقات بالتأكيد تم فتحها_ ☑️️'

else 
data[tostring(target)]["mutes"]["mute_sticker"] = "❌"
 save_data(_config.moderation.data, data)

return '🌟| _مرحبا عزيزي_ \n🌟| _تم فتح الملصقات_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _جهات الاتصال بالتأكيد تم قفلها_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_contact"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل جهات الاتصال_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _جهات الاتصال بالتأكيد تم فتحها_ ☑️️'

else 
data[tostring(target)]["mutes"]["mute_contact"] = "❌"
 save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم فتح جهات الاتصال_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _التوجيه بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _التوجيه بالتأكيد تم فتحها_ ☑️️'
else 
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الملفات بالتأكيد تم قفلها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الملفات بالتأكيد تم فتحها_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الاشعارات بالتأكيد تم فتحها_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_tgservice"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل الاشعارات_ ☑️️'
end
end
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الكيبورد بالتأكيد تم قفله_ ☑️️'

else
 data[tostring(target)]["mutes"]["mute_keyboard"] = "☑️️" 
save_data(_config.moderation.data, data) 

return '🌟| _مرحبا عزيزي_ \n🌟| _تم قفل الكيبورد_ ☑️️'
...
return '🌟| _مرحبا عزيزي_ \n🌟| _الكيبورد بالتأكيد تم فتحه_ ☑️️'
 
else 
data[tostring(target)]["mutes"]["mute_keyboard"] = "❌"
 save_data(_config.moderation.data, data) 

return '🌟| _مرحب�� عزيزي_ \n🌟| _تم فتح الكيبورد_ ☑️️'
...
local mutes = data[tostring(target)]["mutes"]
 ...
 .."\n🌟| مطور الـسـورس : @jgjgjgjgj"
 .."\n🌟| قناه الـسـورس : https://t.me/joinchat/AAAAAEAo-QxlZdlf4x6SGw \n"
...
return '🌟| _مرحبآ عزيزي_\n🌟| _تم حفظ القوانين بنجاح_☑️️\n🌟| _اكتب [ القوانين ] لعرضها 💬_'
 ...
 if not data[tostring(chat)]['rules'] then
  ...
  if matches[1] == "ضع تكرار بالزمن" and is_mod(msg) then
    ...
    return "🌟|_تم وضع التكرار :_ *[ "..matches[2].." ]*"
...
return "🌟| _اوه ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا يوجد ادمنيه ليتم مسحهم_ ☑️️"
...
return "🌟| _مرحبآ عزيزي_ \n🌟| _تم حذف الادمنيه بنجاح_ ☑️️"
			
         end
			if matches[2] == "قائمه المنع" then
				if next(data[tostring(chat)]['filterlist']) == nil then

					return "🌟| _اوه ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا توجد كلمات ممنوعه ليتم حذفها_ ☑️️"
				...
				return "🌟| _مرحبآ عزيزي_ \n🌟| _تم حذف الكلمات الممنوعه بنجاح_ ☑️️"
...
return "🌟| _اوه ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا يوجد قوانين ليتم مسحه_ ☑️️"
             
				end
					data[tostring(chat)]['rules'] = nil
					save_data(_config.moderation.data, data)

return "🌟| _مرحبآ عزيزي_ \n🌟| _تم حذف القوانين بنجاح_ ☑️️"
			
       end
			if matches[2] == "الترحيب"  then
				if not data[tostring(chat)]['setwelcome'] then
    
return "🌟| _اوه ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا يوجد ترحيب ليتم مسحه_ ☑️️"
             
				end
					data[tostring(chat)]['setwelcome'] = nil
					save_data(_config.moderation.data, data)

return "🌟| _مرحبآ عزيزي_ \n🌟| _تم حذف الترحيب بنجاح_ ☑️️"
...
return "🌟| _اوبس ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا يوجد وصف ليتم مسحه_ ☑️️"
...
return "🌟| _اوبس ☢ هنالك خطأ_ 🚸\n🌟| _عذرا لا يوجد مدراء ليتم مسحهم_ ☑️️"
  ...
  if matches[1] == "ضع وصف" and matches[2] and is_mod(msg) then
   ...
   tdcli.changeChannelAbout(chat, matches[2], dl_cb, nil)
    ...
    data[tostring(chat)]['about'] = matches[2]
     ...
     return "🌟| _تم وضع الوصف بنجاح_☑️️"
      
  end
  if matches[1] == "الوصف" and msg.to.type == "chat" and is_owner(msg) then
 if not data[tostring(chat)]['about'] then

      about = "🌟| _لا يوجد وصف ليتم عرضه _☑️️*"
...
..'</code> ]\n<b>🌟| موقعك :</b> <i>'..rank
..'</i>\n🌟| مـطـور الـسـورس : @jgjgjgjgj\n🌟| قـنـاه الـسـورس : https://t.me/joinchat/AAAAAEAo-QxlZdlf4x6SGw'
...
if matches[1] == "ايقاف" and is_mod(msg) then
    ...
    welcome = data[tostring(chat)]['settings']['welcome']
	if welcome == "❌" then
	return "🌟| _مرحبا عزيزي_\n🌟| _الترحيب بالتأكيد معطل_ ☑️️"
			else
		data[tostring(chat)]['settings']['welcome'] = "❌"
	    save_data(_config.moderation.data, data)
return "🌟| _مرحبا عزيزي_\n🌟| _تم ايقاف الترحيب_ ☑️️"
			end
end
    ...
    lock_woring = data[tostring(chat)]['settings']['lock_woring']
	if lock_woring == "❌" then
	return "🌟| _مرحبا عزيزي_\n🌟| _التحذير بالتأكيد معطل_ ☑️️"
			else
		data[tostring(chat)]['settings']['lock_woring'] = "❌"
	    save_data(_config.moderation.data, data)
return "🌟| _مرحبا عزيزي_\n🌟| _تم ايقاف التحذير_ ☑️️"
			end
	end
	end
...
if matches[1] == "الترحيب"  and is_mod(msg) then
		...
		return "🌟| مرحباً عزيزي\n🌟| نورت المجموعه \n🌟| تابع : https://t.me/joinchat/AAAAAEAo-QxlZdlf4x6SGw"
	end
	end
end
end
