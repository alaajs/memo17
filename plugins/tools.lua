...
if matches[1]:lower() == "ارسل ملف" and matches[2] and matches[3] then
		...
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, '@jgjgjgjgj', dl_cb, nil)
	end
